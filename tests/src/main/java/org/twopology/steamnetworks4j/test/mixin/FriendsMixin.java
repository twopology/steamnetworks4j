package org.twopology.steamnetworks4j.test.mixin;
...
import static org.twopology.steamnetworks4j.SteamNativeHandle.getNativeHandle;
...
public class FriendsMixin {
	...
	public void processInput(String input) {
		...
		if (input.equals("persona get")) {
			...
			// friends.setPersonaName(personaName); // Removed - not available in current SDK
